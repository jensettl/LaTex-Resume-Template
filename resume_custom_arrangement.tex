...
\begin{rSection}
    ...
    \begin{tabular}{ccc}
        ...
        \begin{minipage}{0.3\textwidth}
        \begin{itemize}
        \item Begeisterung für Automatisierung
        \item Schnelle Auffassungsgabe
        \end{itemize}
        \end{minipage} &
        \begin{minipage}{0.3\textwidth}
        \begin{itemize}
        \item \raggedright{Erfahrung mit RPA und UIPath}
...
\begin{rSection}{Berufserfahrung}
    ...
    \begin{itemize}
        ...
        \item \raggedright{Planung und Durchführung von Sprint-Reviews und Retrospektiven nach SCRUM Methoden.}
    \end{itemize}
    ...
    \begin{itemize}
        \itemsep -3pt {}
        \item \raggedright{Repräsenation der Studierenden in Hochschulinternen Angelegeheiten.}
        \item \raggedright{Generierung neuer Firmenbeziehungen und Sponsoren für die Fachschaft.}
        \item \raggedright{Steigerung der Teamfähigkeit durch die Planung und Durchführung von Events und Workshops}
        \item \raggedright{Management von Konflikten zwischen Studierenden und Dozenten.} 
    \end{itemize}
\end{rSection}
...
\begin{rSection}{Bildungsweg}
    {\bf Hochschule Karlsruhe - Technik und Wirtschaft}, Bachelor Wirtschaftsinformatik  \hfill {Erwartet 2025}
    \begin{itemize}
...
\begin{rSection}{Projekte}
    \vspace{0.5em}
    \justifying{In meinem Studium und meiner Freizeit, aus Begeisterung für Lösen von Problemen durch Software,  habe ich sowohl eigenständig als auch im Team eine Vielzahl von Projekten durchgeführt, 
